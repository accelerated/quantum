...
public:
    ...
    /// @brief Sets the range of coroutine queueIds covered by Queue::Id::Any when using Dispatcher::post
    /// @param[in] coroQueueIdRangeForAny The range [minQueueId, maxQueueId] of queueIds that Queue::Id::Any
    /// will cover.
